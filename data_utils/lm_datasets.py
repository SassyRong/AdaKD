...
class LMTrainDataset(Dataset):
    ...
    def _process_lm(self, i, samp, model_data, no_model_data, gen_data):
        ...
        #     # right padding
        #     model_data["input_ids"][i][self.max_length-input_len+1:] = torch.tensor(input_ids[:-1], dtype=torch.long)
        #     model_data["attention_mask"][i][self.max_length-input_len+1:] = 1.0
        # else:
