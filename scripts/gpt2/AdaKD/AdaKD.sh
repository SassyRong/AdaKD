...
SIGMA=${8-0.05}
EPISILON=${9-0.05}
SAVE_PATH="${BASE_PATH}/results/gpt2/train/daad/daad_rule[${RULE}]_loss[${LOSS_FN}]_c${T_SCALE}_sigma${SIGMA}_episilon${EPISILON}_trend/seed${SEED}"
...
# OPTS+=" --model-ema"
OPTS+=" --wandb-name daad_1.5Bto0.1B_bs${BATCH_SIZE}_lr${LR}_G${GRAD_ACC}_seed${SEED}_rule[${RULE}]_loss[${LOSS_FN}]_c${T_SCALE}_sigma${SIGMA}_episilon${EPISILON}"
OPTS+=" --wandb-project distill_gpt2_trend"
