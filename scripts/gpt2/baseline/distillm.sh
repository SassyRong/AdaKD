...
SEED=${4-10}
# runtime
SAVE_PATH="${BASE_PATH}/results/gpt2/train/distillm/distillm_seed${SEED}"
RULE="nmtkd"
...
# OPTS+=" --model-ema"
OPTS+=" --wandb-name distillm_1.5Bto0.1B_bs${BATCH_SIZE}_lr${LR}_G${GRAD_ACC}_seed${SEED}"
